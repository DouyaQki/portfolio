class App extends React.Component {
  ...
  keyboardPressed(e) {
    ...
    if (e.keyCode === keyboard[keyboardPressed]) {
      ...
      const $drumText = document.getElementById('typeOfDrum')
      $drumText.innerText = e.key.toUpperCase()
    }
  }

  onClickKey(e) {
    const $drumText = document.getElementById('typeOfDrum')
    const $drumData = document.getElementById(e.target.id)
